...
import com.worldpay.constants.Yworldpayb2cdemoConstants;



/**
 * This is the extension manager of the Yworldpayb2cdemo extension.
 */
public class Yworldpayb2cdemoManager extends GeneratedYworldpayb2cdemoManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Yworldpayb2cdemoManager.class.getName());
	 ...
	 */
	public static Yworldpayb2cdemoManager getInstance()
	{
		return (Yworldpayb2cdemoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Yworldpayb2cdemoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Yworldpayb2cdemoManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Yworldpayb2cdemoManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Yworldpayb2cdemoManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Yworldpayb2cdemoManager called, current tenant: " + getTenant().getTenantID());
		}
	}
